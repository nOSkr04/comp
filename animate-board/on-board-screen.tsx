...
import { OnboardingData, data } from "./animate-board/data";
import { BoardCard } from "./animate-board/board-card";
import { Pagination } from "./animate-board/pagination";
import { CustomButton } from "./animate-board/custom-button";
